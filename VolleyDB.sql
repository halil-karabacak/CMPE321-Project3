...
ALTER TABLE MatchSession DROP PRIMARY KEY;
ALTER TABLE MatchSession ADD PRIMARY KEY (session_ID);
ALTER TABLE MatchSession MODIFY COLUMN session_ID INT AUTO_INCREMENT;
...
ALTER TABLE SessionSquads DROP PRIMARY KEY;
ALTER TABLE SessionSquads ADD PRIMARY KEY (squad_ID);
ALTER TABLE SessionSquads MODIFY COLUMN squad_ID INT AUTO_INCREMENT;
DESCRIBE SessionSquads;
...
INSERT INTO MatchSession ( team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 0, 0, 1, '10.03.2024', 'o_ozcelik', 4.5);
INSERT INTO MatchSession ( team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 1, 1, 1, '03.04.2024', 'o_ozcelik', 4.9);
INSERT INTO MatchSession ( team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 0, 1, 3, '03.04.2024', 'o_ozcelik', 4.4);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 2, 2, 2, '03.04.2024', 'm_sevinc', 4.9);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 3, 2, 2, '03.04.2023', 'e_sener', 4.5);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 3, 1, 1, '27.05.2023', 's_engin', 4.4);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 0, 1, 1, '01.09.2022', 'm_sevinc', 4.6);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 0, 2, 3, '02.05.2023', 'o_ozcelik', 4.7);
INSERT INTO MatchSession (team_ID, stadium_ID, time_slot, date, assigned_jury_username, rating) VALUES ( 1, 0, 1, '10.03.2024', 'o_ozcelik', 4.5);
...
BEGIN
    ...
    IF conflict_count > 0 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Conflict detected for the requested time and stadium.';
    END IF;
END$$
...
BEGIN
    ...
    -- Check for any existing match sessions assigned to the player that overlap with the new match session time
    ...
    IF conflict_count > 0 THEN
        ...
        SET MESSAGE_TEXT = 'Cannot assign player to multiple matches at the same time slot.';
    END IF;
END;
